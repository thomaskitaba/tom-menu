  ...
  return (
    <>
      ...
      <div className="nav-container">
        <div className="logo-container1"><logo /></div>
        <div className="nav-menu-1" onClick={(e)=> {setShowMegaMenu(!showMegaMenu)}}>
          ...
          <a href="#packages"><div className="nav-comment">Packages</div></a>
        </div>
      </div>
    </>
  );
